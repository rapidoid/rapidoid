 ...
 * public static final Tag {{(x[0].toUpperCase().replace(/-/g, '_'))}} = GUI.fa("{{1}}");
 */
...
public final class FA extends RapidoidThing {
	...
	public static final Tag CODE = GUI.fa("code");
	...
	public static final Tag COMMENT = GUI.fa("comment");
	...
	public static final Tag LANGUAGE = GUI.fa("language");
	...
	public static final Tag REPEAT = GUI.fa("repeat");
