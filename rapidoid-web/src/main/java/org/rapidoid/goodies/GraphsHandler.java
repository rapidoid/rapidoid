...
public class GraphsHandler extends GUI implements Callable<Object> {
	...
	public Object call() throws Exception {
		...
		Object numOpenDesc = dygraph("Open files and connections", Metrics.NUM_FILE_DESC);
		Object numThreads = dygraph("Number of JVM threads", Metrics.NUM_THREADS);

		Tag rowCpu = row(col6(sysCpu), col6(userCpu));
		Tag rowMem = row(col6(memTotal), col6(memUsed));
		Tag rowNum = row(col6(numOpenDesc), col6(numThreads));

		return multi(rowCpu, rowMem, rowNum);
	}
