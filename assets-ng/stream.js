Rapidoid.app.factory('StreamData', [ '$http', function($http) {
...
Rapidoid.app.controller('StreamController', [ '$scope', '$http', '$window', '$attrs', 'StreamData',
...
Rapidoid.app.controller('StreamItemController', [ '$scope', '$http', '$window', '$attrs',
