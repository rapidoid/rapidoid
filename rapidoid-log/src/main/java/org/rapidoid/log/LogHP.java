...
public class LogHP {
	...
	public static void audit(String msg, String key, long value) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key, value);
		}
	}

	public static void audit(String msg, String key, double value) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key, value);
		}
	}

	public static void audit(String msg, String key, boolean value) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key, value);
		}
	}

	public static void audit(String msg, String key1, Object value1, String key2, long value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}

	public static void audit(String msg, String key1, Object value1, String key2, double value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}

	public static void audit(String msg, String key1, Object value1, String key2, boolean value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}

	public static void audit(String msg, String key1, long value1, String key2, long value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}

	public static void audit(String msg, String key1, double value1, String key2, double value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}

	public static void audit(String msg, String key1, boolean value1, String key2, boolean value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}

	public static void audit(String msg, String key1, long value1, String key2, double value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}

	public static void audit(String msg, String key1, double value1, String key2, boolean value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}

	public static void audit(String msg, String key1, long value1, String key2, boolean value2) {
		if (Log.isAuditEnabled()) {
			Log.audit(msg, key1, value1, key2, value2);
		}
	}
	...
	public static void severe(String msg, String key, long value) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key, value);
		}
	}

	public static void severe(String msg, String key, double value) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key, value);
		}
	}

	public static void severe(String msg, String key, boolean value) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key, value);
		}
	}

	public static void severe(String msg, String key1, Object value1, String key2, long value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}

	public static void severe(String msg, String key1, Object value1, String key2, double value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}

	public static void severe(String msg, String key1, Object value1, String key2, boolean value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}

	public static void severe(String msg, String key1, long value1, String key2, long value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}

	public static void severe(String msg, String key1, double value1, String key2, double value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}

	public static void severe(String msg, String key1, boolean value1, String key2, boolean value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}

	public static void severe(String msg, String key1, long value1, String key2, double value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}

	public static void severe(String msg, String key1, double value1, String key2, boolean value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}

	public static void severe(String msg, String key1, long value1, String key2, boolean value2) {
		if (Log.isSevereEnabled()) {
			Log.severe(msg, key1, value1, key2, value2);
		}
	}
